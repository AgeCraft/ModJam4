...
public class MJPacketHandler<T> {
	...
	public MJPacketHandler(String channel, FMLIndexedMessageToMessageCodec<T> codec) {
	...
	public void sendToAllPlayers(MJMessage message) {
